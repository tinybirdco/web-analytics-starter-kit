    ...
    return [
      {
        ...
        question:
          'What are the top 5 referrers in the last 6 days ordered by traffic?',
        color: 'green',
      },
      {
        id: 'visitors-trend',
      ...
      },
      {
        ...
        question:
          'How many pageviews did I have in the last 31 days and what is the trend?',
        color: 'orange',
      },
      {
        id: 'bounce-rate',
        ...
        question:
          'What is my bounce rate for the last month and how does it compare to previous periods?',
        color: 'green',
      },
      {
        id: 'top-location',
  ...
  return [
    ...
    },
    {
      ...
      description: `${formatNumber(
        data.visitorsTrend.visits
      )} Visitors ${getTrendArrow(data.visitorsTrend.trend)} ${formatPercentage(
        data.visitorsTrend.percentage
      )}`,
      question:
        'How many visitors did I have in the last 7 days and what is the trend?',
      color: 'purple',
    ...
    },
    {
      ...
      subtitle: `Pageviews in the last 31 days`,
      description: `${formatNumber(
        data.pageviewsTrend.pageviews
      )} Pageviews ${getTrendArrow(
        data.pageviewsTrend.trend
      )} ${formatPercentage(data.pageviewsTrend.percentage)}`,
      question:
        'How many pageviews did I have in the last 31 days and what is the trend?',
      color: 'orange',
      type: 'metric',
    },
    {
      ...
      )} Bounce rate ${getTrendArrow(data.bounceRate.trend)} ${formatPercentage(
        data.bounceRate.percentage
      )}`,
      question:
        'What is my bounce rate for the last month and how does it compare to previous periods?',
      color: 'green',
    ...
    },
    {
      id: 'top-location',
      title: 'Top Location',
      metric: formatCountry(data.topLocation.location),
      subtitle: `is driving more traffic during the last month`,
      description: `${formatCountry(
        data.topLocation.location
      )} is driving more traffic ${getTrendArrow(
        data.topLocation.trend
      )} ${formatPercentage(data.topLocation.percentage)}`,
      question:
        'Which countries are driving the most traffic and how has this changed recently?',
      color: 'purple',
      type: 'list',
    },
    {
      id: 'top-browser',
      title: 'Top Browser',
      metric: formatBrowser(data.topBrowser.browser),
      subtitle: `is the most popular browser for your user base`,
      description: `${formatBrowser(
        data.topBrowser.browser
      )} is the most popular browser ${getTrendArrow(
        data.topBrowser.trend
      )} ${formatPercentage(data.topBrowser.percentage)}`,
      question:
        'What are the most popular browsers among my users and how does this vary by time period?',
      color: 'orange',
      type: 'list',
